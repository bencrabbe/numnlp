...
# server set up.
c.CourseDirectory.course_id = "bftal3"
...
#  Default: ''
# c.CourseDirectory.root = '/Users/bcrabbe/Linear Algebra/bftal3'
...
#  Default: {'ir': <function InstantiateTests.<lambda> at 0x12bd6ed40>, 'python': <function InstantiateTests.<lambda> at 0x12bd6edd0>, 'python3': <function InstantiateTests.<lambda> at 0x12bd6ee60>}
# c.InstantiateTests.sanitizers = {'ir': <function InstantiateTests.<lambda> at 0x12bd6ed40>, 'python': <function InstantiateTests.<lambda> at 0x12bd6edd0>, 'python3': <function InstantiateTests.<lambda> at 0x12bd6ee60>}
